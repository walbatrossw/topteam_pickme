									...
									<div class="ty3_wrap">
										<div class="content_wrap">
											<div class="content_col2_2">
												<a href="/companies/30139/info/%EC%82%BC%EC%84%B1%EC%A0%84%EC%9E%90?" class="llogo"> 
													<img src="/img/company/company.png">
												</a>
											</div>
											<div class="col-xs-7 content_col2_3 cominfo">
										  		<p class="us_titb_l3">
													<a href=""><strong>${companyInfoList.companyName }</strong></a>
													<!-- <button class="btn_heart1 btn_follow" data-company_id="30139">following</button> -->
												</p>
												<p>
													<span class="us_stxt_1">${companyInfoList.industryTopIndexName }</span> <span class="vbar">|</span>
													<span href="" class="us_stxt_1">경기</span><br>
												</p>
												<p class="row_end">
													<a href="/companies/30139/reviews/%EC%82%BC%EC%84%B1%EC%A0%84%EC%9E%90?" class="us_stxt_1">${companyInfoList.reviewCount } 기업리뷰</a> <span class="vbar">|</span>
													<a href="/companies/30139/salaries/%EC%82%BC%EC%84%B1%EC%A0%84%EC%9E%90?" class="us_stxt_1">${companyInfoList.salaryCount } 연봉정보</a> <span class="vbar">|</span>
													<a href="/companies/30139/interviews/%EC%82%BC%EC%84%B1%EC%A0%84%EC%9E%90?" class="us_stxt_1">${companyInfoList.interviewCount } 면접정보</a>
												</p>
											</div>
