								...
								<table summary="기본정보">
									...
									<tbody>
										...
										<tr>
											...
											<td><a class="link_job_view">채용 진행중 <strong class="point">${companyInfoDetail.recruitCount}건</strong></a></td>
										</tr>
										<tr>
											<th scope="row">사원수</th>
											<td class="position3">525명 <span class="standard_year">(2012년기준)</span>
											</td>
											<th scope="row">매출액</th>
											<td class="position4">
												<fmt:formatNumber value="${companyInfoDetail.companySales }" pattern="\#,###.##"/>만원
												<span class="standard_year">(2012년 기준)</span> 
											</td>
										</tr>
										<tr>
											<th scope="row">자본금</th>
