...
<div class="container">
      <div class="terms-title"><h3 style="font-weight: bolder;"class="page-header">개인정보 취급방침</h3></div>

<div class="terms-contents">
  <h3>1. 개인정보의 처리 목적</h3>
  <p><protect you up> (‘http://pickmetop.cafe24.com/’이하 ‘PICK ME’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.</p>
  <ol>
    <li>고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등</li>
  </ol>
  <h3>2. 개인정보처리 위탁</h3>
  <ol>
    <li><protect you up> ('PICK ME') 은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</li>
    <li><protect you up> ('http://pickmetop.cafe24.com/'이하 'PICK ME') 은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.</li>
  ...
  <ol>
    <li><protect you up> (http://pickmetop.cafe24.com/'이하 'PICK ME') 은(는) 다음의 개인정보 항목을 처리하고 있습니다.
      <table class="table">
        <thead>
          <tr>
            <th>수집방법</th>
  ...
  <h3>5. 개인정보의 파기</h3>
  <p><protect you up> ('PICK ME') 은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.</p>
  <ul>
    <li>파기절차
  ...
  <p><protect you up> ('PICK ME') 은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.</p>
  <ol>
    ...
    <li>해킹 등에 대비한 기술적 대책
      <p><protect you up>(' PICK ME ')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.</p>
    </li>
    <li>개인정보에 대한 접근 제한
  ...
  <ol>
    <li>protect you up(‘http://pickmetop.cafe24.com/’이하 ‘PICK ME) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
      <ul>
        <li>개인정보 보호책임자
          <ul>
            <li>성명: 이예은</li>
            <li>직책: 이예은</li>
            <li>직급: 이예은</li>
            <li>연락처: yeaeun1220@gmail.com<br/>※ 개인정보 보호 담당부서로 연결됩니다.</li>
          </ul>
        </li>
        <li>개인정보 보호 담당부서
          <ul>
            <li>부서명: protect you up </li>
            <li>담당자: 이예은</li>
            <li>연락처: yeaeun1220@gmail.com</li>
          </ul>
        </li>
      </ul>
    </li>
    <li>정보주체께서는 protect you up(‘http://pickmetop.cafe24.com/’이하 ‘PICK ME) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. protect you up(‘http://pickmetop.cafe24.com/’이하 ‘PICK ME) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</li>
  </ol>
