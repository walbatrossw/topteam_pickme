...
public class CoverletterService {
	...
	public CoverletterCompanyJobVo getCoverletterCompanyJobVo(String recruitJobCd){
		return coverletterDao.selectCoverletterCompanyJobByRecruitJobCd(recruitJobCd);
	}
